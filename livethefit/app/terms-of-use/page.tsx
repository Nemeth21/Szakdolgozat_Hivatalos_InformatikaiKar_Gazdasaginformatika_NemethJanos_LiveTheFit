...
const TermsPage = () => {
  ...
  const beuszasOsztaly = (id: string) =>
  ...
  return (
    ...
    <div className="min-h-screen font-inter font-mono flex flex-col items-center bg-gray-50 px-6 py-12 relative">
      ...
      <h1 className={`text-5xl md:text-6xl font-extrabold text-black text-center mt-24 transition-all duration-700 ease-out ${beuszasOsztaly('title')}`} id="title">
        TERMS & CONDITIONS
      </h1>
      <p className={`text-orange-500 flex items-center text-sm mt-2 transition-all duration-700 ease-out delay-100 ${beuszasOsztaly('update-date')}`} id="update-date">
      ...
      <div className="w-full flex justify-end mt-8">
        ...
        <div
          id="bg-section1"
          className={`w-full md:w-1/2 h-64 md:h-96 bg-cover bg-center rounded-lg shadow-lg transition-all duration-700 ease-out delay-200 ${beuszasOsztaly('bg-section1')}`}
      ...
      <div className="max-w-4xl text-gray-800 mt-8 space-y-6 text-justify leading-relaxed">
        ...
        <p id="intro1" className={`transition-all duration-700 ease-out ${beuszasOsztaly('intro1')}`}>
        ...
        <div className="w-full flex justify-start pt-8">
          ...
          <div
            ...
            id="bg-section2"
            className={`w-full md:w-1/2 h-64 md:h-96 bg-cover bg-center rounded-lg shadow-lg transition-all duration-700 ease-out ${beuszasOsztaly('bg-section2')}`}
        ...
        <p id="agreement" className={`transition-all duration-700 ease-out delay-100 ${beuszasOsztaly('agreement')}`}>
        ...
        <div className="w-full flex justify-end pt-8">
          ...
          <div
            ...
            id="bg-section3"
            className={`w-full md:w-1/2 h-64 md:h-96 bg-cover bg-center rounded-lg shadow-lg transition-all duration-700 ease-out ${beuszasOsztaly('bg-section3')}`}
            style={{ backgroundImage: "url('/terms3.jpg')" }}

          ></div>
        </div>

        <h2 id="heading1" className={`text-xl font-bold mt-6 pt-6 transition-all duration-700 ease-out ${beuszasOsztaly('heading1')}`}>1. WHO WE ARE AND HOW TO CONTACT US</h2>
        <p id="who" className={`transition-all duration-700 ease-out ${beuszasOsztaly('who')}`}>

          <strong>1.1 Who we are.</strong> LIVETHEFIT is a company registered in Debrecen. Our main office is at Derbrecen 1.
        </p>


        <p id="contact" className={`transition-all duration-700 ease-out delay-100 ${beuszasOsztaly('contact')}`}>
        ...
        <div className="w-full flex justify-start pt-8">
          ...
          <div
            id="bg-section4"
            className={`w-full md:w-1/2 h-64 md:h-96 bg-cover bg-center rounded-lg shadow-lg transition-all duration-700 ease-out ${beuszasOsztaly('bg-section4')}`}
        ...
        <p id="security" className={`transition-all duration-700 ease-out pt-6 ${beuszasOsztaly('security')}`}>
        ...
        <p id="ethics" className={`transition-all duration-700 ease-out delay-100 ${beuszasOsztaly('ethics')}`}>
        ...
        <p id="updates" className={`transition-all duration-700 ease-out delay-200 ${beuszasOsztaly('updates')}`}>
        ...
        <footer className="w-full mt-12 border-t border-gray-300 pt-6 pb-4 text-center text-gray-600 text-sm">
          <p>
            ...
            <span className="text-orange-500 font-bold">IN hungaryt</span>.
          </p>
        </footer>
      </div>
    </div>
